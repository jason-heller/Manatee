...
public class Color {
	...
	public static final Color LIGHT_BLUE = new Color(156, 220, 254).immutable(true);
	public static final Color LIGHT_GREEN = new Color(181, 206, 168).immutable(true);
	...
	public static final Color SALMON = new Color("#CE9178").immutable(true);
