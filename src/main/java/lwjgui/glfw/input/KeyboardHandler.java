...
public final class KeyboardHandler {
	...
	public KeyboardHandler(Window stage) {
		...
		stage.getKeyCallback().addCallback(keyCallback);
		stage.getCharCallback().addCallback(charCallback);
		stage.getCharModsCallback().addCallback(modCallback);
	}
