...
public class ImageView extends FillableRegion {
	...
	public ImageView(IPicture image) {
		this();
		setImage(image);
	}
	...
	public void setImage(IPicture image) {
	...
	public ImageView clone()
	{
		...
		clone.setMaintainAspectRatio(this.stretchToFit);
		clone.setPrefSize(this.getPrefWidth(), this.getPrefHeight());
