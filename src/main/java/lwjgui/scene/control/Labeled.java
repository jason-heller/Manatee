...
public abstract class Labeled extends Control implements TextFillable {
	...
	public void render(Context context) {
		...
		if (this.isSelected())
		{
			...
			NanoVG.nvgTextBounds(vg, absX, absY, useString, bounds);
			NanoVG.nvgFillColor(vg, Theme.current().getSelection().getNVG());
			NanoVG.nvgBeginPath(vg);
			NanoVG.nvgRect(vg, bounds[0], bounds[1], bounds[2]-bounds[0], bounds[3]-bounds[1]);
		    NanoVG.nvgFill(vg);
		}
