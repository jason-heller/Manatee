...
import manatee.cache.definitions.loader.ResourceLoader;
...
public class Texture2D implements ITexture
{
	...
	private final static Logger logger = (Logger) LoggerFactory.getLogger("IO");
	
	public static Texture2D load(String path)
	{
		ByteBuffer buf = ResourceLoader.ioResourceToByteBuffer(path, 8 * 1024);
		...
		Texture2D tex = new Texture2D(buf);
		return tex;
	}
